...
![Screenshot of the green "Use this template" button.](use-this-template.png)

## Step 2: Configuring the Markdown

The publication Markdown is found in the `paper.md` file. At the top you can edit the
...
A full Markdown example is given in [paper.md](paper.md). This includes instructions how to include
